...
(function ($) {
    ...
    Jconfirm.prototype = {
        ...
        _buildHTML: function () {
            ...
            var contentDiv = this.$el.find('div.content_confirm');
        ...
        _bindEvents: function () {
            ...
            $('div.jconfirm .buttons > button:last-child').focus();
        },
        setDialogCenter: function () {
            ...
            this.$b.find('.content_confirm').css({
                'max-height': h - 200 + 'px'
            });
            this.$b.css({
                'margin-top': mar
    ...
    jconfirm.pluginDefaults = {
        template: '<div class="jconfirm"><div class="jconfirm-bg"></div><div class="container"><div class="row"><div class="col-md-6 col-md-offset-3 span6 offset3"><div class="jconfirm-box"><div class="closeIcon"><span class="glyphicon glyphicon-remove"></span></div><div class="title"></div><div class="content_confirm"></div><div class="buttons pull-right"></div><div class="jquery-clear"></div></div></div></div></div></div>',
        title: 'Hello',
